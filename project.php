...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Projecto con id  <?php echo $_GET['id'] ?></title>
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
			...
			<div class="content-wrap">
				...
				============================================= -->
				<div class="portfolio-single-image portfolio-single-image-full" style="background-image: url('images/portfolio/parallax/10.jpg');" data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;"></div><!-- .portfolio-single-image end -->
