...
<head>
    ...
    <link rel="stylesheet" href="css/estilos_propios.css" type="text/css" />
...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="slider" class="slider-element force-full-screen full-screen">
			...
			<div class="force-full-screen full-screen dark" style="background-image: url('images/home.jpg');background-position: 50% 0;">

				<div class="container clearfix">
					<div class="slider-caption slider-caption-center">
						<h2 data-animate="fadeInDown">Bienvenido a mi página web</h2>
        ...
        <!--EMPIEZA OTRA SECCIÓN -->
        <div class="section nobottommargin notopmargin notoppadding" >
